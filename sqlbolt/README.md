...
```
sqlbolt/
├── sqlbolt-core.sql          # Lessons 0–18 (Core)
├── sqlbolt-intermediate.sql  # Intermediate topics
└── README.md
```
...
- [x] Review: Simple SELECT Queries
...
- [x] Lesson 15: Deleting rows
- [x] Lesson 16: Creating tables
- [x] Lesson 17: Altering tables
- [x] Lesson 18: Dropping tables

### Intermediate Topics
- [x] Intermediate SQL Topics (Overview)
- [x] Subqueries
- [x] Unions, Intersections & Exceptions
